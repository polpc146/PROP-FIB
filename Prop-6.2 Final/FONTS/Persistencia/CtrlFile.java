...
public class CtrlFile {
    ...
    /**
     * Crear un nuevo "index.csv" donde primero añadiremos todos los documentos
     * que habian en el antiguo "index.csv"
     * @param nameDocs todos los nombres de los documentos que hay en el "index.csv" antiguo
     * @throws IOException
     */
    /*public void SaveInOtherIndex(LinkedList<String> nameDocs) throws IOException {
    }*/
...
/*
    public void changeNameSheet(String nameDoc, String oldName, String newName, Vector<String> aux) {
    }
