...
public class DateOperation {
    ...
    private String whatDayOfWeek (int dayOfWeek) {
        String dayWeek = "";
        if (dayOfWeek == 0) dayWeek = "Sunday";
        else if (dayOfWeek == 1) dayWeek = "Monday";
        else if (dayOfWeek == 2) dayWeek = "Tuesday";
        else if (dayOfWeek == 3) dayWeek = "Wednesday";
        else if (dayOfWeek == 4) dayWeek = "Thursday";
        else if (dayOfWeek == 5) dayWeek = "Friday";
        else if (dayOfWeek == 6) dayWeek = "Saturday";
        return dayWeek;
    }
}
