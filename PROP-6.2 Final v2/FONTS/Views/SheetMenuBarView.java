...
public class SheetMenuBarView extends JMenuBar {
    ...
    public SheetMenuBarView(SheetView sheetView) {
        ...
        JMenuItem sea = new JMenuItem("Search");
        JMenuItem cop = new JMenuItem("Copy & Paste");
        JMenuItem cut = new JMenuItem("Cut & Paste");
        textOp.add(rep);
        textOp.add(sea);
        textOp.add(cop);
        textOp.add(cut);
        ...
        ActionListener Search = new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                String str1 = JOptionPane.showInputDialog("String/s to search");
                try {
                    sheetView.Search(str1);
                } catch (Exception ex) {
                    ex.printStackTrace();
                }
            }
        };
        sea.addActionListener(Search);
        ...
        ActionListener Copy = new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    sheetView.copy(cell1,cell2);
                } catch (Exception ex) {
                    ex.printStackTrace();
                }
            }
        };
        cop.addActionListener(Copy);
        ...
        JMenuItem asc = new JMenuItem("Ascendant");
        JMenuItem desc = new JMenuItem("Descendant");
        sort.add(asc);
        sort.add(desc);
        add(sort);
        ...
        ActionListener Asc = new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                String cell2 = JOptionPane.showInputDialog("Final rank cell. Example: d2");
                try {
                    sheetView.sortAsc(cell1, cell2);
                } catch (Exception ex) {
                }
            }
        };
        asc.addActionListener(Asc);
        ...
        ActionListener Desc = new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                String cell2 = JOptionPane.showInputDialog("Final rank cell. Example: d2");
                try {
                    sheetView.sortDesc(cell1, cell2);
                } catch (Exception ex) {
                }
            }
        };
        desc.addActionListener(Desc);
    }
}
