...
public class SheetView extends JFrame {
     ...
     * @throws Exception
     */
    public void Search (String ElementToFind) throws Exception {

        String nameSheet = listView.getSelected();
        int[] celda;
        celda = modifyPresentationCtrl.Search(nameSheet, ElementToFind);
        if (celda[0] >= 0) {

            int index = listView.getSelectedIndex();
            sheetPanes.get(index).Search(celda[0], celda[1]);
            centerPanel.revalidate();
            centerPanel.repaint();
        }
    }
    ...
    public void sortAsc (String cell1, String cell2) throws Exception {
        ...
        int colF = colToInt(cell2.substring(0,1));
        String nameSheet = listView.getSelected();
        modifyPresentationCtrl.sortRank(nameSheet, rowI, colI, rowF, colF, "A");
        centerPanel.revalidate();
        centerPanel.repaint();
    }

    public void sortDesc (String cell1, String cell2) throws Exception {
        ...
        int colF = colToInt(cell2.substring(0,1));
        String nameSheet = listView.getSelected();
        modifyPresentationCtrl.sortRank(nameSheet, rowI, colI, rowF, colF, "D");
        centerPanel.revalidate();
        centerPanel.repaint();
    }

    public void copy (String cell1, String cell2) throws Exception {
        ...
        int colF = colToInt(cell2.substring(0,1));
        int index = listView.getSelectedIndex();
        int RowI = sheetPanes.get(index).getSelectedRow();
        int ColI = sheetPanes.get(index).getSelectedCol();
        String nameSheet = listView.getSelected();
        modifyPresentationCtrl.CopyRank(nameSheet, rowI, colI, rowF, colF, RowI, ColI);
        centerPanel.revalidate();
        centerPanel.repaint();
    }

    public void cut (String cell1, String cell2) throws Exception {
        ...
        int ColI = sheetPanes.get(index).getSelectedCol();
        String nameSheet = listView.getSelected();
        modifyPresentationCtrl.MoveRank(nameSheet, rowI, colI, rowF, colF, RowI, ColI);
        centerPanel.revalidate();
        centerPanel.repaint();
    }
}
